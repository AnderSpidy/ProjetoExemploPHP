    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                {{-- Lista de produtos no pedido
                <div id="list-pedidos-produtos" class="list-group my-3 overflow-auto">
            ...
            <div class="col-md-3">
                ...
                <select id="list-tipo-produtos" class="form-select my-1">
                    <option value="1">Pizza</option>
                    <option value="2">Suco</option>
                    <option value="3">Cerveja</option>
                </select>
                <select id="lista-produtos" class="form-select my-1">
